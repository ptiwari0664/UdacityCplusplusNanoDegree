...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            // Generate unique pointer to graph node
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // Pass raw pointers to avoid transfering ownership
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // Owning reference
                        }
    ...
    // member handle should have the current address of the bot
    _chatBot = &localBot; 
    
    // move bot to the node
