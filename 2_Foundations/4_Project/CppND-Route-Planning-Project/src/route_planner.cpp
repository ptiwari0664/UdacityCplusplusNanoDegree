...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node)
{
    ...
    //Method:1
    // for (RouteModel::Node *neighbours : current_node->neighbors)
    // {
...
{
    float val1 = node1->g_value + node1->h_value;
    float val2 = node2->g_value + node2->h_value;
    return val1 > val2;
}
...
RouteModel::Node *RoutePlanner::NextNode()
{
    ...
    RouteModel::Node *lowestSummation = open_list.back();
    open_list.pop_back();

    return lowestSummation;
}
